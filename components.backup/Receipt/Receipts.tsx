...
import {
  resetUploadFields,
  validateForm,
} from "@/services/ui-helper-functions";
...
const ReceiptsComponent = () => {
  ...
  useEffect(() => {
    ...
    const receiptUrlInput = document.getElementById("receipt-url") as
      | HTMLInputElement
      | any;
    const photoCanvas = document.getElementById(
      "photo-canvas"
    ...
    const cameraWarning = document.getElementById(
      "camera-warning"
