        ...
        <div className="bg-white p-6 rounded-lg shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{formatCurrency(analyticsData.metrics.total_saved)}</p>
            </div>
            <FaDollarSign className="w-8 h-8 text-green-500" />
          </div>
          <p className="text-sm text-gray-600 mt-2">Across {analyticsData.metrics.total_goals} goals</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{formatCurrency(analyticsData.metrics.monthly_avg_saved)}</p>
            </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{analyticsData.metrics.transfer_success_rate}%</p>
            </div>
            <FaBullseye className="w-8 h-8 text-purple-500" />
          </div>
          <p className="text-sm text-gray-600 mt-2">{analyticsData.metrics.total_transfers} total transfers</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{analyticsData.metrics.current_streak}</p>
            </div>
            <FaTrophy className="w-8 h-8 text-orange-500" />
          </div>
          <p className="text-sm text-gray-600 mt-2">Best: {analyticsData.metrics.longest_streak} days</p>
        </div>
      </div>
