...
const AddGoalModal = ({ show, onClose, onAdd, goalToEdit, editGoalId }: Props) => {
    ...
    const categories = [
        "Emergency Fund", "Savings", "Debt Payoff", "Retirement", "Home",
        "Car", "Education", "Travel", "Other"
    ];
    ...
    return (
        <Modal show={show} onHide={onClose} onExited={resetForm} centered>
            ...
            <form noValidate className={`needs-validation goal-form ${validated ? 'was-validated' : ''}`} onSubmit={handleSubmit}>
                <Modal.Body>
                    <div className="mb-3">
