  ...
  const fetchTransactions = async (accountId: string) => {
    ...
    try {
      ...
      const res = await getData(
        `/api/banking/transactions?filter=${encodeURIComponent(filter)}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
                  ...
                  >
                      ...
                      <div className="text-right">
                        ...
                        {acc.creditLimit && (
                          <p className="text-xs text-gray-400">
                            Credit Limit: $
                            {parseFloat(acc.creditLimit).toFixed(2)}
                          </p>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-gray-600">
                      ...
                      <div>
                        ...
                        {acc.institution || "AU Institution"}
                      </div>
                      <div>
                    ...
                    {isActive && (
                      <>
                        ...
                        {txnError && (
                          <p className="text-red-500 mt-4">{txnError}</p>
                        )}
                                ...
                                return (
                                  ...
                                  >
                                    ...
                                    <div className="text-xs text-gray-500 mt-1">
                                      {date} &middot; {txn.direction || "—"}{" "}
                                      &middot; {txn.class || "Unclassified"}
                                    </div>
                                  </li>
                                );
                              })}
        ...
        <div className="shadow-xl border border-gray-100 p-8 rounded-lg transition-all duration-300">
          ...
          <form onSubmit={formik.handleSubmit} className="space-y-6">
            ...
            <div className="pt-4">
              ...
              {formik.status && (
                <p className="mt-2 text-sm text-gray-600">{formik.status}</p>
              )}
