  ...
  <div className="tab-pane fade" id="income-content" role="tabpanel">
    ...
    <div className="row g-3">
      <div className="col-md-6">
        <label htmlFor="interest-income" className="form-label">
      ...
      <div className="col-md-6">
        <label htmlFor="dividend-income" className="form-label">
      ...
      <div className="col-md-6">
        <label htmlFor="trust-income" className="form-label">
          Trust Distributions
        </label>
        <input
          type="number"
      ...
      <div className="col-md-6">
        <label htmlFor="rental-income" className="form-label">
      ...
      <div className="col-md-6">
        <label htmlFor="capital-gains" className="form-label">
          Capital Gains
        </label>
        <input
          type="number"
    ...
    <div className="row g-3">
      <div className="col-md-6">
        <label htmlFor="govt-payment-type" className="form-label">
          Types of Pensions or Benefits
        </label>
        <input type="text" className="form-control" id="govt-payment-type" />
      </div>
      <div className="col-md-3">
        <label htmlFor="govt-payment-amount" className="form-label">
          Amount Received
        </label>
        <input
          type="number"
      ...
      <div className="col-md-3">
        <label htmlFor="govt-payment-tax" className="form-label">
          Tax Withheld
        </label>
        <input
          type="number"
    ...
    <div className="row g-3">
      <div className="col-md-6">
        <label htmlFor="foreign-income" className="form-label">
          Foreign Income
        </label>
        <input
          type="number"
      ...
      <div className="col-md-6">
        <label htmlFor="business-income" className="form-label">
          Business Income
        </label>
        <input
          type="number"
      ...
      <div className="col-md-6">
        <label htmlFor="super-income" className="form-label">
      ...
      <div className="col-md-6">
        <label htmlFor="partnership-income" className="form-label">
