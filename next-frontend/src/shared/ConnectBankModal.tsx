    ...
    <Modal show={show} onHide={handleClose} size="lg">
      ...
      <Modal.Body>
        <Alert variant="info">
          ...
          You&apos;re in development mode. You can create mock data or add a
          custom bank account.
        </Alert>

        <Tab.Container activeKey={key} onSelect={(k) => setKey(k ?? "mock")}>
          ...
          <Tab.Content>
            <Tab.Pane eventKey="mock">
              ...
              <p>
                Would you like to connect to your bank account and import mock
                transactions?
              </p>
              <Button
                variant="primary"
                ...
                {({ errors, touched }) => (
                  <FormikForm>
                    ...
                    <Form.Group className="mb-3">
                      ...
                      />
                      <Form.Text>
                        For demo purposes only, enter any 4 digits
                      </Form.Text>
                      <Form.Control.Feedback type="invalid">
