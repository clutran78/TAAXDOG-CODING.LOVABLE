        ...
        <div className="modal-dialog modal-lg">
            <div className="modal-content">
                            ...
                            <div className="card bg-primary text-white">
                                <div className="card-body">
                                    <div className="d-flex justify-content-between align-items-center">
                                        ...
                                        <h3 className="mb-0" id="modal-net-balance-value">$0.00</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="row">
                        <div className="col-md-6 mb-3">
                            <div className="card h-100">
                                ...
                                <div className="card-body">
                                    <h3 className="text-success" id="modal-balance-income-value">$0.00</h3>
                                    <div className="mt-3">
                        ...
                        <div className="col-md-6 mb-3">
                            <div className="card h-100">
                                ...
                                <div className="card-body">
                                    <h3 className="text-danger" id="modal-balance-expenses-value">$0.00</h3>
                                    <div className="mt-3">
                ...
                <div className="modal-footer">
                    ...
                    <button type="button" className="btn btn-primary" id="analyze-balance-btn">
