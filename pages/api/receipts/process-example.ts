...
const validations = [
  body('imageData')
    ...
    .isBase64()
    .withMessage('Image data must be base64 encoded')
    .custom(validateImageData),
  body('contentType').optional().custom(validateContentType),
  body('category')
    .optional()
...
export default withSecurity(
  async (req: AuthenticatedNextApiRequest, res: NextApiResponse) => {
    ...
    if (!req.user) {
      return apiResponse.unauthorized(res, { error: 'Authentication required' });
    }
