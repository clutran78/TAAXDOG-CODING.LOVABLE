import { prisma, getQueryMetrics, getSlowQueries, checkDatabaseHealth, QueryMetrics } from "./prisma-optimized";
import { NextApiRequest, NextApiResponse } from "next";

// Helper to add query metrics to API responses in development
export const withQueryMetrics = (handler: (req: NextApiRequest, res: NextApiResponse) => Promise<void>) => {
