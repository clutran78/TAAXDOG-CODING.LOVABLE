...
export class ATOCompliance {
   ...
   */
  static validateBASRequirements(businessData: {
  ...
  static categorizeExpense(
    ...
    return {
      category: isBusinessExpense
        ? 'Other business expenses'
        : this.INDIVIDUAL_TAX_CATEGORIES.D5.name,
  ...
  static async generateTaxSummary(
    ...
    const estimatedTax = this.calculatePAYGWithholding(taxableIncome, 'monthly', true, false) * 12;
