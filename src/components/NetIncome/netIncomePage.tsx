...
import { IncomeSource, IncomeTransactionResult } from '@/lib/types/income';
...
const NetIncomePage = () => {
  ...
  const loadIncomeDetails = async () => {
    try {
      setLoading(true);
      const { sources, total } = (await fetchIncomeTransactions()) as IncomeTransactionResult;
    ...
    <>
      ...
      <div className={`"container py-4`}>
        ...
        {loading ? (
          ...
          >
            <i className="fas fa-info-circle me-2"></i>No income sources found. Add or connect your
            bank account.
          </div>
        ) : (
