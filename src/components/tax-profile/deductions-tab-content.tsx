...
const DeductionsTabContent: React.FC<Props> = ({ goToNextTab }) => (
  ...
  >
    ...
    <div className="alert alert-info">
      <i className="fas fa-info-circle me-2"></i> Additional deduction sections will include travel
      expenses, clothing expenses, self-education, and other work-related expenses.
    </div>
