...
import { fetchTaxProfile, subscribeToAuthState } from '@/services/firebase-service';
  ...
  const NavTabs: React.FC = () => (
    ...
    >
      {Object.entries(TAB_IDS).map(([key, id]) => (
        ...
        >
          <button
            className={`nav-link ${id === TAB_IDS['Personal Information'] ? 'active' : ''} `}
            id={id}
            data-bs-toggle="tab"
  ...
  return (
    <div className="container my-4">
      ...
      <div className="alert alert-info mt-3">
        ...
        Complete your tax profile to help our AI identify potential tax deductions and optimize your
        financial planning.
      </div>
