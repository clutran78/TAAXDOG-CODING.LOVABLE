      ...
      >
        ...
        <div className="modal-body">
          ...
          <div
            ...
            style={{ display: 'none' }}
          >
            <i className="fas fa-info-circle me-2"></i>No income sources found. Connect your bank
            account to see your income details.
          </div>
