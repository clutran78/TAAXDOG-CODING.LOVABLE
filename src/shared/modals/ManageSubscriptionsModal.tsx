      ...
      <div className="modal-dialog modal-lg">
        <div className="modal-content">
          ...
          <div className="modal-body">
            ...
            <div
              id="no-subscriptions-message"
              className="alert alert-info"
            >
              <i className="fas fa-info-circle me-2"></i>No subscriptions found. Add your first
              subscription or connect your bank to automatically detect them.
            </div>
            ...
            <div className="card mt-4">
              ...
              <div className="card-body">
                ...
                <p className="text-secondary small">
                  The app will analyze your transactions and automatically detect recurring payments
                  that might be subscriptions. You can review and confirm these detections.
                </p>
                  ...
                  <div className="d-flex">
                    ...
                    <div>
                      ...
                      <p className="small mb-0">
                        ...
                        merchant. When a pattern is detected, it suggests adding them as
                        subscriptions.
                      </p>
                    </div>
                  </div>
