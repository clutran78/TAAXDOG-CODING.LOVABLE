...
exports.commonValidations = {
  email: (0, express_validator_1.body)('email').isEmail().normalizeEmail().trim().escape(),
  ...
  amount: (0, express_validator_1.body)('amount').isFloat({ min: 0 }).toFloat(),
  description: (0, express_validator_1.body)('description').trim().escape().isLength({ max: 1000 }),
