...
-- CreateEnum
CREATE TYPE "AuthEvent" AS ENUM ('LOGIN_SUCCESS', 'LOGIN_FAILED', 'LOGOUT', 'REGISTER', 'PASSWORD_RESET_REQUEST', 'PASSWORD_RESET_SUCCESS', 'PASSWORD_CHANGE', 'EMAIL_VERIFICATION', 'ACCOUNT_LOCKED', 'ACCOUNT_UNLOCKED', 'TWO_FACTOR_ENABLED', 'TWO_FACTOR_DISABLED', 'TWO_FACTOR_SUCCESS', 'TWO_FACTOR_FAILED', 'SESSION_EXPIRED', 'SUSPICIOUS_ACTIVITY');

-- CreateEnum
CREATE TYPE "Plan" AS ENUM ('SMART', 'PRO');

-- CreateEnum
CREATE TYPE "TaxReturnStatus" AS ENUM ('DRAFT', 'SUBMITTED', 'PROCESSING', 'COMPLETED', 'REJECTED');
...
CREATE TABLE "users" (
    ...
    "abn" TEXT,
    "tfn" TEXT,
    "taxResidency" "TaxResidency" NOT NULL DEFAULT 'RESIDENT',
...
-- CreateIndex
CREATE UNIQUE INDEX "tax_returns_userId_year_key" ON "tax_returns"("userId", "year");
